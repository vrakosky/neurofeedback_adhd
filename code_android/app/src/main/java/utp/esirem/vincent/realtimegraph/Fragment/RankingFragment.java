package utp.esirem.vincent.realtimegraph.Fragment;
...
import utp.esirem.vincent.realtimegraph.Model.Ranking;
import utp.esirem.vincent.realtimegraph.R;
import utp.esirem.vincent.realtimegraph.ScoreDetail;
import utp.esirem.vincent.realtimegraph.ViewHolder.RankingViewHolder;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new FirebaseRecyclerAdapter<Ranking, RankingViewHolder>(
            ...
            protected void populateViewHolder(RankingViewHolder viewHolder, final Ranking model, int position) {
                ...
                viewHolder.txt_score_plus.setText(String.valueOf(model.getScorePlus()));
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for(DataSnapshot data:dataSnapshot.getChildren())
                        {
                            ...
                            sumScorePlus+=Integer.parseInt(ques.getScorePlus());
                        }
                        ...
                        Ranking ranking = new Ranking(userName,sumScore,sumScorePlus);
