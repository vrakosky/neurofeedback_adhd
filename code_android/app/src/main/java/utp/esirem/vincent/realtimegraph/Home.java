...
import utp.esirem.vincent.realtimegraph.Fragment.CategoryFragment;
import utp.esirem.vincent.realtimegraph.Fragment.RankingFragment;
        ...
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if(intent.getAction().equals(Common.STR_PUSH))
                {
                    ...
                    showNotification("Message from App Owner",message);
                }
            }
        };
    }
